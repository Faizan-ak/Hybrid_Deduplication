...
<link href="<%=request.getContextPath()%>/Files/CSS/styles.css" rel="stylesheet" type="text/css" />  <%-- background --%>
...
<body onload="startTimer();" >
	...
	<div class="main">
		...
		<div class="header"><h1>A Hybrid Cloud Approach for Secure</h1></div>
		<div class="headerline2"><h1>Authorized Deduplication</h1></div>
